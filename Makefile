...
OBJS=db.o draw.o equate.o xwin.o readfont.o rubber.o opt_parse.o \
   ...
   ev.o com_shell.o expr.o paper.o readshpfont.o
...
paper.h paper.c lex.c Makefile PROCDATA.P MENUDATA_V TEXTDATA.F NOTEDATA.F \
opt_parse.c opt_parse.h com_change.c readfont.c readfont.h rlgetc.c \
rlgetc.h rubber.c rubber.h token.c token.h xwin.c xwin.h \
...
drawnew.o: equate.h
drawnew.o: ev.h
drawnew.o: postscript.h
drawnew.o: readfont.h
drawnew.o: rubber.h
drawnew.o: xwin.h
draw.o: db.h
draw.o: eprintf.h
...
path.o: path.h
postscript2.o: db.h
postscript2.o: postscript.h
postscript2.o: xwin.h
postscriptedit.o: db.h
postscriptedit.o: postscript.h
postscriptedit.o: xwin.h
postscript.o: db.h
postscript.o: ev.h
postscriptold.o: db.h
postscriptold.o: postscript.h
postscriptold.o: xwin.h
