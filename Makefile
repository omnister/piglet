...
com_move.c  com_point.c com_show.c com_window.c coords.c db.c db.h \
draw.c eprintf.c eprintf.h eventnames.h geom_circle.c geom_inst.c \
geom_line.c geom_arc.c  geom_poly.c geom_rect.c geom_text.c lex.c lex.h \
...
lex.o:         rlgetc.h db.h token.h xwin.h lex.h eprintf.h readfont.h 
